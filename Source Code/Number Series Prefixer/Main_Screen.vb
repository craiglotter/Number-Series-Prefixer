            ...
            If finfo.Exists = True Then
                ...
                While reader.Peek <> -1
                    ...
                    If whichbuttonpressed = 1 Then
                        ...
                        seriescounterstring = seriescounter.ToString
                        While seriescounterstring.Length < NumericUpDown3.Value
                            seriescounterstring = "0" & seriescounterstring
                        End While
                        If CheckBox1.Checked = True Then
                            seriescounterstring = seriescounterstring & "."
                        End If
                        For i As Integer = 1 To NumericUpDown4.Value
                            seriescounterstring = seriescounterstring & " "
                        Next
                        seriescounter = seriescounter + NumericUpDown2.Value

                        lineread = seriescounterstring & lineread
